...
class DataManager:
    def __init__(self):
        ...
        self.f1Schedule = {
            (2026, 3): {6: ["Практика 1", "Практика 2 (Австралия)"], 7: ["Практика 3", "Квалификация"],
                        8: ["Гонка: Австралия"],
                        13: ["Практика 1", "Квал-я к спринту (Китай)"], 14: ["Спринт", "Основная квалификация"],
                        15: ["Гонка: Китай"],
                        27: ["Практика 1", "Практика 2 (Япония)"], 28: ["Практика 3", "Квалификация"],
                        29: ["Гонка: Япония"]},
            (2026, 4): {10: ["Практика 1", "Практика 2 (Бахрейн)"], 11: ["Практика 3", "Квалификация"],
                        12: ["Гонка: Бахрейн"],
                        17: ["Практика 1", "Практика 2 (Саудовская Аравия)"], 18: ["Практика 3", "Квалификация"],
                        19: ["Гонка: Саудовская Аравия"]},
            (2026, 5): {1: ["Практика 1", "Квал-я к спринту (Майами)"], 2: ["Спринт", "Основная квалификация"],
                        3: ["Гонка: Майами"],
                        22: ["Практика 1", "Квал-я к спринту (Канада)"], 23: ["Спринт", "Основная квалификация"],
                        24: ["Гонка: Канада"]},
            (2026, 6): {5: ["Практика 1", "Практика 2 (Монако)"], 6: ["Практика 3", "Квалификация"],
                        7: ["Гонка: Монако"],
                        12: ["Практика 1", "Практика 2 (Испания)"], 13: ["Практика 3", "Квалификация"],
                        14: ["Гонка: Испания"],
                        26: ["Практика 1", "Квал-я к спринту (Австрия)"], 27: ["Спринт", "Основная квалификация"],
                        28: ["Гонка: Австрия"]},
            (2026, 7): {3: ["Практика 1", "Практика 2 (Великобритания)"], 4: ["Практика 3", "Квалификация"],
                        5: ["Гонка: Великобритания"],
                        17: ["Практика 1", "Практика 2 (Бельгия)"], 18: ["Практика 3", "Квалификация"],
                        19: ["Гонка: Бельгия"],
                        24: ["Практика 1", "Практика 2 (Венгрия)"], 25: ["Практика 3", "Квалификация"],
                        26: ["Гонка: Венгрия"]},
            (2026, 8): {21: ["Практика 1", "Практика 2 (Нидерланды)"], 22: ["Практика 3", "Квалификация"],
                        23: ["Гонка: Нидерланды"]},
            (2026, 9): {4: ["Практика 1", "Практика 2 (Италия)"], 5: ["Практика 3", "Квалификация"],
                        6: ["Гонка: Италия"],
                        11: ["Практика 1", "Практика 2 (Испания, Мадрид)"], 12: ["Практика 3", "Квалификация"],
                        13: ["Гонка: Мадрид"],
                        25: ["Практика 1", "Практика 2 (Азербайджан)"], 26: ["Практика 3", "Квалификация"],
                        27: ["Гонка: Азербайджан"]},
            (2026, 10): {9: ["Практика 1", "Практика 2 (Сингапур)"], 10: ["Практика 3", "Квалификация"],
                         11: ["Гонка: Сингапур"],
                         23: ["Практика 1", "Квал-я к спринту (США)"], 24: ["Спринт", "Основная квалификация"],
                         25: ["Гонка: Остин"],
                         30: ["Практика 1", "Практика 2 (Мексика)"], 31: ["Практика 3", "Квалификация"]},
            (2026, 11): {1: ["Гонка: Мексика"],
                         6: ["Практика 1", "Квал-я к спринту (Бразилия)"], 7: ["Спринт", "Основная квалификация"],
                         8: ["Гонка: Бразилия"],
                         19: ["Практика 1", "Практика 2 (Лас-Вегас)"], 20: ["Практика 3", "Квалификация"],
                         21: ["Гонка: Лас-Вегас"],
                         27: ["Практика 1", "Квал-я к спринту (Катар)"], 28: ["Спринт", "Основная квалификация"],
                         29: ["Гонка: Катар"]},
            (2026, 12): {4: ["Практика 1", "Практика 2 (Абу-Даби)"], 5: ["Практика 3", "Квалификация"],
                         6: ["Гонка: Абу-Даби"]}
        }

        self.fifaSchedule = {
            (2026, 6): {11: ["Матч открытия (Мехико)"],
            ...
            (2026, 7): {1: ["1/16 финала"], 2: ["1/16 финала"], 3: ["1/16 финала"],
    ...
    def addNote(self, dateKey, textValue):
        if dateKey not in self.userEvents:
            self.userEvents[dateKey] = []
        self.userEvents[dateKey].append(textValue)
        self.saveEvents()

    def deleteNote(self, dateKey, indexValue):
        if dateKey in self.userEvents:
            self.userEvents[dateKey].pop(indexValue)
...
class CalendarApplication:
    def __init__(self):
        ...
        self.uiRenderer = UIElementRenderer()
    ...
    def renderInterface(self, mousePosition):
        ...
        # Меню
        self.uiRenderer.drawPanel(self.displayScreen, rectangleMenu)
        ...
        for itemText in listMenuNames:
            ...
            if isActive:
                self.uiRenderer.drawRoundedRect(self.displayScreen, colorBackgroundHover, itemRectangle, 12)
                ...
                if itemRectangle.collidepoint(mousePosition):
                    self.uiRenderer.drawRoundedRect(self.displayScreen, colorBackgroundCell, itemRectangle, 12)
                    currentColor = colorTextWhite
                else:
        ...
        if self.activeTab == "Календарь":
            self.uiRenderer.drawPanel(self.displayScreen, rectangleCentral)
            ...
            for buttonObject, listPoints in [(self.buttonLeft, [(-4, 0), (4, -6), (4, 6)]),
                ...
                self.uiRenderer.drawRoundedRect(self.displayScreen,
                                                colorBackgroundHover if isHover else colorBackgroundCell, buttonObject,
                                                buttonSize // 2)
                self.uiRenderer.drawRoundedRect(self.displayScreen, colorBorderLine, buttonObject, buttonSize // 2, 1)
            ...
            currentF1Events = self.dataManager.f1Schedule.get((self.currentYear, self.currentMonth), {})
            currentFifaEvents = self.dataManager.fifaSchedule.get((self.currentYear, self.currentMonth), {})
            ...
            for indexRow, currentWeek in enumerate(calendarData):
                for indexColumn, numberDay in enumerate(currentWeek):
                    ...
                    if numberDay != 0:
                        ...
                        if isToday:
                            self.uiRenderer.drawRoundedRect(self.displayScreen, colorBlueDim, cellRectangle, 16)
                            self.uiRenderer.drawRoundedRect(self.displayScreen, colorBlue, cellRectangle, 16, 2)
                        else:
                            self.uiRenderer.drawRoundedRect(self.displayScreen,
                                                            colorBackgroundHover if isHover else colorBackgroundCell,
                                                            cellRectangle, 16)
                            self.uiRenderer.drawRoundedRect(self.displayScreen, colorBorderLine, cellRectangle, 16, 1)

                        if isSelected and not isToday:
                            self.uiRenderer.drawRoundedRect(self.displayScreen, colorTextWhite, cellRectangle, 16, 2)
                        ...
                        if numberDay in currentF1Events:
                            tagHeight = self.uiRenderer.drawPillBadge(self.displayScreen, "F1 Сессия",
                                                                      cellRectangle.x + 16, tagPositionY, colorF1Dim,
                                                                      colorF1)
                            tagPositionY += tagHeight + 6

                        if numberDay in currentFifaEvents:
                            tagHeight = self.uiRenderer.drawPillBadge(self.displayScreen, "ЧМ 2026",
                                                                      cellRectangle.x + 16, tagPositionY, colorFifaDim,
                                                                      colorFifa)
                            tagPositionY += tagHeight + 6

                        listUserEntries = self.dataManager.userEvents.get(
                            (self.currentYear, self.currentMonth, numberDay), [])
                        if listUserEntries:
                            countText = f"{len(listUserEntries)} Заметк{'а' if len(listUserEntries) == 1 else 'и'}"
                            self.uiRenderer.drawPillBadge(self.displayScreen, countText, cellRectangle.x + 16,
                                                          tagPositionY, colorBlueDim, colorBlue)

                        self.listDayButtons.append((cellRectangle, numberDay))

            # Главный экран
            self.uiRenderer.drawPanel(self.displayScreen, rectangleRightPanel)
            ...
            if self.selectedDay:
                ...
                if isTodaySelected:
                    self.uiRenderer.drawPillBadge(self.displayScreen, "СЕГОДНЯ", rectangleRightPanel.x + 32,
                ...
                if self.selectedDay in currentF1Events:
                    ...
                    for sessionText in currentF1Events[self.selectedDay]:
                        ...
                        self.uiRenderer.drawRoundedRect(self.displayScreen, colorBackgroundApp, cardRectangle, 12)
                ...
                listUserEntries = self.dataManager.userEvents.get(
                    (self.currentYear, self.currentMonth, self.selectedDay), [])
                ...
                if listUserEntries:
                    for indexEntry, stringEntry in enumerate(listUserEntries):
                        ...
                        self.uiRenderer.drawRoundedRect(self.displayScreen,
                                                        colorBackgroundHover if isHover else colorBackgroundApp,
                                                        cardRectangle, 12)
                        if isHover: self.uiRenderer.drawRoundedRect(self.displayScreen, colorBorderLine, cardRectangle,
                                                                    12, 1)
                ...
                self.rectangleInput = pygame.Rect(rectangleRightPanel.x + 32, rectangleRightPanel.bottom - 80,
                                                  widthRight - 64, 48)
                self.uiRenderer.drawRoundedRect(self.displayScreen, colorBackgroundApp, self.rectangleInput, 24)
                self.uiRenderer.drawRoundedRect(self.displayScreen, colorBlue if self.inputActive else colorBorderLine,
            ...
            listAllRaces = []
            for monthKey, daysDictionary in self.dataManager.f1Schedule.items():
            ...
            for indexValue, raceItem in enumerate(listAllRaces):
                ...
                self.uiRenderer.drawRoundedRect(self.displayScreen, colorBackgroundCell, cardRectangle, 12)
                pygame.draw.rect(self.displayScreen, colorF1, (cardRectangle.x, cardRectangle.y + 10, 4, 28),
                                 border_radius=2)
            ...
            listAllMatches = []
            for monthKey, daysDictionary in self.dataManager.fifaSchedule.items():
                yearValue, monthValue = monthKey
                for dayValue, sessionsList in daysDictionary.items():
                    for sessionString in sessionsList:
            ...
            listAllNotes = []
            for dateKey, notesList in self.dataManager.userEvents.items():
                        ...
                        if self.activeTab == "Календарь":
                            ...
                            for deleteRectangle, entryIndex in self.listDeleteButtons:
                                ...
                                if hitboxRectangle.collidepoint(mousePosition):
                                    ...
                                    self.dataManager.deleteNote(dateKey, entryIndex)
                    ...
                    if eventObject.key == pygame.K_F11:
                        ...
                        if eventObject.key == pygame.K_RETURN:
                            if self.userText.strip():
                                dateKey = (self.currentYear, self.currentMonth, self.selectedDay)
                                self.dataManager.addNote(dateKey, self.userText.strip())
                                self.userText = ""
